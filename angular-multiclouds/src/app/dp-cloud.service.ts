...
export class DpCloudService {
  ...
  dropBoxClLogin() {
    const dpUrl =
      'https://www.dropbox.com/oauth2/authorize?client_id=4kbv0so8hjs83lf&response_type=code&scope=account_info.read files.metadata.read files.content.write files.content.read&redirect_uri=https://stormy-headland-33273.herokuapp.com/cloudmanagement/';
        ...
        return await new Promise((resolve, reject) => {
          ...
          dbx
            ...
            .then((response) => {
              ...
              console.log(
                'hpldDpFiles ' + JSON.stringify(hpldDpFiles[0].path_lower)
              );
